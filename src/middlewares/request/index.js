		...
		const validationSchema = await checkSchema(
			{
				...
				rol: {
					...
					isIn: {
						...
						errorMessage:
							'The value must be one of the following: frontend, backend, fullstack',
					},
				},
				lenguage: {
					notEmpty: {
					...
					isIn: {
						options: ['javascript', 'ruby', 'phyton'],
						errorMessage:
							'The value must be one of the following: javascript, ruby, phyton',
					},
				},
			},
			['body']
